<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="RemoverUser.aspx.cs" Inherits="New_Login.User.RemoverUser" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container">
        ...
        <div class="text-center text-primary">
            <h2>Remover Dados do Usuario</h2>
        </div>
        ...
        <div class="form-inline my-2 my-lg-0" style="padding-top: 20px;" >
            <Asp:Button id="btnRemover" class="btn btn-outline-danger" runat="server" 
