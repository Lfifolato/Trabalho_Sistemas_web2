<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="ListaForn.aspx.cs" Inherits="New_Login.Fornecedor.ListaForn" %>
            ...
            <asp:Repeater ID="rptUsuarios" runat="server" OnItemDataBound="rptUsuarios_ItemDataBound">
                ...
                <ItemTemplate>
                    <tr>
                        ...
                        <td>
                            <%# DataBinder.Eval(Container.DataItem, "razao") %>
                        </td>
                        <td>
                        ...
                        <td>
                            ...
                            <a href='<%# Eval("id", "DetalhesForn.aspx?id={0}") %>'>
                                <span class="fas fa-eye"></span>
                            </a>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lnkEditar" runat="server">
                            <a href='<%# Eval("id", "EditarForn.aspx?id={0}") %>'>
                                <span class="fas fa-pencil-alt"></span>
                            </a>
                            </asp:LinkButton>
                            <asp:LinkButton ID="lnkRemover" runat="server">
                            <a href='<%# Eval("id", "RemoverForn.aspx?id={0}") %>'>
